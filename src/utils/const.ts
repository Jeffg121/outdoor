...
const SUP_TITLE = IS_CHINESE ? '桨板' : 'Sup';
...
export const HIKE_COLOR = '#FE9900';
export const SWIM_COLOR = '#6495ED';
export const ROWING_COLOR = '#6495ED';
export const SUP_COLOR = '#6495ED';
export const FLIGHT_COLOR = [dark_vanilla, dark_vanilla];
export const KAYAKING_COLOR = [red, red];
export const SKI_COLOR = '#FFFAFA';
